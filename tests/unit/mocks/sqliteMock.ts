...
/**
 * Mirrors NitroSQLite's `databaseExists` — true once a database with this name
 * has been opened (and not yet closed/deleted).
 */
...
export {open, databaseExists, resetAllDatabases};
