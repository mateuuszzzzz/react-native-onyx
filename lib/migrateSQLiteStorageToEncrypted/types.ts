...
type MigrateSQLiteStorageToEncrypted = (options: MigrateSQLiteStorageToEncryptedOptions) => MigrationResult;

export type {MigrationResult, MigrateSQLiteStorageToEncryptedOptions, MigrateSQLiteStorageToEncrypted};
